...
public class Coordinatore {
	...
	public static void main(String[] args) {
		try {
			...
			String url1 = "http://localhost:8080/axis2/services/InterfacciaOffertaCasa";
			String url2 = "http://localhost:8080/axis2/services/InterfacciaRichiestaCasa";
			String url3 = "http://localhost:8080/axis2/services/InterfacciaAttrazioni";
			String url4 = "http://localhost:8080/axis2/services/InterfacciaServiziAccessori";
